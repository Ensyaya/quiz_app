...
class QuizController extends Controller
{
    ...
    public function store(QuizCreateRequest $request)
    {
        ...
        return redirect()->route('quizzes.index')->withSuccess("Quiz Succesfully Created");
    }
    ...
    {
        $quiz = Quiz::with('topTen.user','results.user')->withCount('questions')->find($id)?? abort(404, 'Quiz is not found');
